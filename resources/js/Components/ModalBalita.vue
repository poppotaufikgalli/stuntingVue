...
const props = defineProps(['data', 'modelValue', 'modalBalitaShow']);

const emit = defineEmits(['update:modelValue']);

const modalVisible = ref(props.modalBalitaShow ?? false)
const refNama = ref('')
const start = ref(0)
        ...
        <div class="bg-white border border-gray-200 rounded-t-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
            <div class="p-4 sm:p-7">
                <div class="text-center">
                    <h2 class="block text-2xl font-bold text-gray-800 dark:text-gray-200">Cari Data Balita</h2>
                </div>
                ...
                <div class="mt-5">
                    <div class="flex flex-row gap-4 mb-3">
                        ...
                        <Link 
                            :href="route('penduduk.create', {jns: 'ortu'})"
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    		<tr v-for="(item, key) in sdataOrtu" :key="key" class="hover:bg-gray-300 hover:dark:bg-gray-700" v-on:click="setSelected(item)">
                                <td class="h-px w-px">
