...
function hapusPengukuran(item){
    ...
    swal({
        ...
        if (result.isConfirmed) {
            form.delete(route('remaja.destroy', {id: item.encid}))
        }  
    })
}
...
const submit = () => {
    if(next.value !== 'create'){
        form.post(route('remaja.update', {id: selItemID.value}), {
            onSuccess: () => {
                form.reset()
                closeModal() 
            },
                    ...
                    <div class="p-1.5 min-w-full inline-block align-middle">
                        <div class="overflow-hidden">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody v-if="data.remaja" class="divide-y divide-gray-200 dark:divide-gray-700">
                                    <tr v-for="(item, index) in data.remaja">
            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        <h2 class="block text-2xl font-bold text-gray-800 dark:text-gray-200">Tambah Data Kehamilan</h2>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <form @submit.prevent="submit" class="mt-6 space-y-5">
                            <div class="flex flex-row gap-2">
                                <div class="basis-1/2">
                                    <InputLabel for="usia_kehamilan" value="Kehamilan Ke" />
                                ...
                                <div class="basis-1/2">
                                    <InputLabel for="usia_kehamilan" value="Anak Ke" />
                            ...
                            <div class="flex flex-row gap-2">
                                <div class="basis-1/2">
                                    <InputLabel for="status_hamil" value="Status Kehamilan" />

                                    <SelectInput
                                        id="status_hamil"
                                        class="mt-1 block w-full"
                                        v-model="form.status_hamil"
                                        :options="{
                                            'H': 'Hamil',
                                            'L': 'Lahir',
                                            'G': 'Gugur',
                                    ...
                                    <InputError class="mt-2" :message="form.errors.status_hamil" />
                                </div>
                                
                                <div class="basis-1/2">
                                    <InputLabel for="tgl_lahir" value="Tanggal Perkiraan Lahir / Lahir / Gugur / Abortus" />
                            ...
                            <div>
                                <InputLabel for="catatan" value="Catatan Kehamilan" />
