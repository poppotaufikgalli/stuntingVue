...
<template>
	...
	<AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Hak Akses</h2>
        </template>
			          			...
			          			<table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
			            			...
			            			<tbody v-if="data" class="divide-y divide-gray-200 dark:divide-gray-700">
			              				<tr v-for="(item, key) in data.data" :key="key">
			                				...
			                				<td class="h-px w-72 whitespace-nowrap">
			                  					<div class="px-6 py-3">
			                    					<span class="block text-sm text-gray-500">{{item.users.length}}</span>
			                  					</div>
			                				</td>
			                				<td class="h-px w-px whitespace-nowrap">
			                  					<div class="px-6 py-3">
			                				...
			                				<td class="h-px w-px whitespace-nowrap">
			                  					<div class="px-3 py-1.5">
			                  						<div class="flex justify-between gap-4">
				                    					<Link 
				                    						:href="route('akses.edit', {id: item.encid})"
				                    					...
				                    					<button 
				                    						...
				                    						:class="item.users.length == 0 ? 'text-red-600' : 'text-gray-700' "
				                    					>
				                      						Hapus
				                    					</button>
				                    				</div>
